...
const styles = StyleSheet.create({
  ...
  demoText: { fontFamily: font.mono, fontSize: 9.5, letterSpacing: 0.8, color: colors.muted },
  ...
  sparkLabel: { fontFamily: font.mono, fontSize: 9.5, color: hero.muted, letterSpacing: 0.3 },
  heroFoot: { flexDirection: 'row', alignItems: 'center', marginTop: 18 },
  heroFootVal: { fontFamily: font.monoSemi, fontSize: 17, color: '#FFF' },
  heroFootLbl: { fontFamily: font.mono, fontSize: 10, color: hero.muted, marginTop: 3, letterSpacing: 0.6 },
