...
const styles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: 'rgba(12,17,24,0.45)', justifyContent: 'flex-end' },
  sheet: { backgroundColor: colors.paper, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, padding: 20, paddingTop: 10, maxHeight: '92%' },
  grab: { alignSelf: 'center', width: 40, height: 4, borderRadius: 2, backgroundColor: colors.line, marginBottom: 12 },
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  title: { fontFamily: font.display, fontSize: 21, color: colors.ink, letterSpacing: -0.4 },
  close: { width: 32, height: 32, borderRadius: radius.sm, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center', ...shadow.soft },
  label: { fontFamily: font.mono, fontSize: 10.5, color: colors.muted, marginBottom: 7, textTransform: 'uppercase', letterSpacing: 0.6 },
  input: { backgroundColor: colors.card, borderRadius: radius.md, paddingHorizontal: 13, height: 44, fontFamily: font.med, fontSize: 14.5, color: colors.ink, borderWidth: 1, borderColor: colors.line, outlineStyle: 'none' as any },
  row: { flexDirection: 'row', gap: 12 },
  error: { fontFamily: font.med, fontSize: 11.5, color: colors.danger, marginTop: 5 },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  chip: { paddingHorizontal: 12, height: 32, borderRadius: radius.sm, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center' },
  chipOn: { backgroundColor: colors.ink, borderColor: colors.ink },
  chipText: { fontFamily: font.monoSemi, fontSize: 11.5, color: colors.inkSoft, letterSpacing: 0.2 },
  chipTextOn: { color: '#fff' },
  submit: { flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.accent, height: 50, borderRadius: radius.md, marginTop: 8 },
  submitDim: { opacity: 0.45 },
  submitText: { fontFamily: font.bold, fontSize: 15.5, color: '#fff', letterSpacing: 0.3 },
});
